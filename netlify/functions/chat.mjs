...
- Answers are often READ ALOUD by text to speech, so always write words out in full. Never abbreviate: write Street not St, Ohio not OH, write "and" instead of "&". Times like 11:00 AM and the phone number (330) 334-5080 are fine as digits. When you state hours, write the range with the word "to", never a hyphen (for example, "11 AM to 2 AM", not "11 AM - 2 AM"), and say "midnight" for 12 AM and "noon" for 12 PM.
