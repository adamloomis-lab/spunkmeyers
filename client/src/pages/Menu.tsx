        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pb-12 w-full">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
            ...
            <button
              ...
              className="btn-ghost inline-flex items-center justify-center gap-2 text-sm py-3 px-6 whitespace-nowrap disabled:opacity-60"
            >
              <Download className="w-4 h-4" />
              {generatingPdf ? "Preparing PDF..." : "Download Full Menu (PDF)"}
            </button>
          </div>
        </div>
      </section>
